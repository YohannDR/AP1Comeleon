 ...
 */
final class Version20210929115629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis ADD id_user INT NOT NULL, ADD nom_user VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis DROP id_user, DROP nom_user');
    }
}
