 ...
 */
class getPrestaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PrestaRepository' shared autowired service.
     *
     * @return \App\Repository\PrestaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PrestaRepository.php';

        return $container->privates['App\\Repository\\PrestaRepository'] = new \App\Repository\PrestaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
